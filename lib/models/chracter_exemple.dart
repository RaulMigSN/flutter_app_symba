...
final exampleCharacter = Character(
  ...
  skillsAndPowers: [
    Skill(
      name: 'Tiro Curvo',
      description: 'Você começa atirando em curva depois ela da uma pirueta',
      level: 'Novato',
      type: 'Habilidade',
      effect: {
        'Novato': SkillDescription(
          action: TypeAction.ativa,
          description: 'Você Atira fazendo curva.',
        )
      },
    )
  ],
  ...
  weapons: [
    Weapon(name: 'Besta de Pulso', damage: '1d10', description: 'Pequena, silenciosa e mortal à curta distância.', price: '', type: '', quality: Quality(name: 'Equilibrada', description: 'Ela é equilibrada'), equiped: true)
  ],
  armors: [
    Armor(name: 'Colete de Couro Enfeitiçado', protection: '1D4', description: 'Oferece proteção leve e mágica contra cortes.', price: '', quality: Quality(name: 'Equilibrada', description: 'Ela é equilibrada'), equiped: true)
  ],
);
